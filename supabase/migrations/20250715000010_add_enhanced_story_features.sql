...
DROP FUNCTION IF EXISTS get_stories_with_user_data();

-- Create the get_stories_with_user_data function to include new columns
CREATE FUNCTION get_stories_with_user_data()
RETURNS TABLE (
    id UUID,
    author_id UUID,
    content TEXT,
