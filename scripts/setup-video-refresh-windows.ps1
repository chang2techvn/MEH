...
# Create the action
$action = New-ScheduledTaskAction -Execute "curl" -Argument "-X POST $DOMAIN/api/cron/daily-video-refresh -H ""Authorization: Bearer $CRON_SECRET"" -H ""Content-Type: application/json"""
