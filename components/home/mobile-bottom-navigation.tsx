            ...
            <div className="flex items-center justify-around max-w-md mx-auto">
                    ...
                    >
                      <Button
                        ...
                        className={`relative group transition-colors h-10 w-10 rounded-xl ${
                          progressModalOpen ? "bg-orange-100 dark:bg-orange-900/30" : "hover:bg-muted"
                        }`}
              ...
              <TooltipProvider>
                <Tooltip>
                        ...
                        <DropdownMenuTrigger asChild>
                          ...
                          >
                            ...
                            {isAuthenticated && user ? (
                              <Avatar className={`relative h-7 w-7 ring-2 transition-all ${
                                profileDropdownOpen 
                                  ? "ring-orange-500/50" 
                                  : "ring-transparent group-hover:ring-gray-400/50"
                              }`}>
                              ...
                              <User className={`relative h-6 w-6 ${
                                profileDropdownOpen 
                                  ? "text-orange-600 dark:text-orange-400" 
                                  : "text-gray-700 dark:text-gray-300"
                              }`} />
                  ...
                  <TooltipContent side="top">
                    <p>{isAuthenticated ? "Profile Menu" : "Sign in"}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
