...
import { getPracticeChallenges } from "@/app/actions/daily-challenges"
...
export default function ChallengeTabs({
  ...
  const loadChallenges = useCallback(async () => {
    try {
      ...
      // Load challenges in background
      getPracticeChallenges(20)
        .then(allChallenges => {
          // Separate auto-generated and user-created challenges
          const autoGeneratedChallenges = allChallenges.filter((c: Challenge) => c.isAutoGenerated)
          const userCreatedChallenges = allChallenges.filter((c: Challenge) => !c.isAutoGenerated)
